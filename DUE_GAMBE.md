...
*2026-09-12 13:00 UTC · nato dalla revisione esterna del 10/09 · sola lettura · €0*
...
**Misure di costo in archivio: 1067** — di cui su indirizzi EVM (Base/Robinhood): **240**, su Solana: **815**.

| chain | token valutabili | con costo misurato sulla SUA chain | copertura |
|---|---|---|---|
| **base** | 745 | 53 | **7.1%** |
| **robinhood** | 1,667 | 59 | **3.5%** |
| **solana** | 742 | 385 | **51.9%** |
