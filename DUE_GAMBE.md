...
*2026-09-11 20:56 UTC · nato dalla revisione esterna del 10/09 · sola lettura · €0*
...
**Misure di costo in archivio: 1049** — di cui su indirizzi EVM (Base/Robinhood): **222**, su Solana: **815**.

| chain | token valutabili | con costo misurato sulla SUA chain | copertura |
|---|---|---|---|
| **base** | 2,297 | 157 | **6.8%** |
| **robinhood** | 1,669 | 48 | **2.9%** |
| **solana** | 1,352 | 385 | **28.5%** |

## Verdetto

> ❌ **Criterio di morte scattato** (scritto da chi sta fuori, prima di guardare): su **base, robinhood** la copertura non è del 100%.
