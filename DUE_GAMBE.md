...
*2026-09-12 04:48 UTC · nato dalla revisione esterna del 10/09 · sola lettura · €0*
...
**Misure di costo in archivio: 1061** — di cui su indirizzi EVM (Base/Robinhood): **234**, su Solana: **815**.

| chain | token valutabili | con costo misurato sulla SUA chain | copertura |
|---|---|---|---|
| **base** | 709 | 50 | **7.1%** |
| **robinhood** | 1,549 | 53 | **3.4%** |
| **solana** | 707 | 385 | **54.5%** |
