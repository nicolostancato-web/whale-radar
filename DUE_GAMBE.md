...
*2026-09-12 09:17 UTC · nato dalla revisione esterna del 10/09 · sola lettura · €0*
...
**Misure di costo in archivio: 1063** — di cui su indirizzi EVM (Base/Robinhood): **236**, su Solana: **815**.

| chain | token valutabili | con costo misurato sulla SUA chain | copertura |
|---|---|---|---|
| **base** | 724 | 50 | **6.9%** |
| **robinhood** | 1,625 | 58 | **3.6%** |
| **solana** | 724 | 385 | **53.2%** |
