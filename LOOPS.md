...
*2026-09-12 00:47 UTC · un meeting per goal, a ogni ciclo (~30 min)*

## Architetto: 🟢 tutti i loop si stanno riunendo

| loop | la domanda | dove siamo | ago | cosa si fa |
|---|---|---|---|---|
| `accumulo-base` | Stiamo raccogliendo token Base nuovi? | 4191 token con dati (2890 osservati dal vivo, 1301 con storico) su 14609 pool noti | ⏸ fermo da 2h | 🚨 fermo da 2h e la scala e' finita: serve una decisione umana |
...
| `percentuale-solana` | Come alziamo la percentuale su Solana? | robusta -16% (media -12%) su 760 token | 📈 si muove | avanti cosi' |
...
| `accumulo-robinhood` | Stiamo raccogliendo token Robinhood nuovi? | 2239 token con dati (103 osservati dal vivo, 2136 con storico) su 18781 pool noti | ⏸ fermo dall'ultimo meeting | ✋ mano alzata: tutti i rimedi noti hanno gia' fallito 3 volte (whale_candles.py, whale_backfill.py, multichain_collector |
