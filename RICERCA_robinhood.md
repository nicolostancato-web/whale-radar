...
*2026-09-16 00:42 UTC · 8 segnali nuovi messi alla prova su 340 token*
...
| `quota_wallet_vincenti x compra_e_rivende (filtro)` | la quota di denaro da wallet con almeno un successo alle spalle MOLTIPLICATO per quanti di quelli che hanno comprato stanno già rivendendo | -98% (-1) |
| `quota_wallet_vincenti / compra_e_rivende (filtro)` | la quota di denaro da wallet con almeno un successo alle spalle RAPPORTATO a quanti di quelli che hanno comprato stanno già rivendendo | -98% (-1) |
...
- `buy_grossi (voto)` — già bocciato 35 volte 2h fa (si riprova fra 10h o quando i dati crescono)
- `buy_grossi (filtro)` — già bocciato 35 volte 2h fa (si riprova fra 10h o quando i dati crescono)
