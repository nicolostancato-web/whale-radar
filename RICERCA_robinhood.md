...
- `n_compratori (filtro)` — già bocciato 27 volte 6h fa (si riprova fra 6h o quando i dati crescono)
- `buy_medio (voto)` — già bocciato 27 volte 6h fa (si riprova fra 6h o quando i dati crescono)
- `buy_medio (filtro)` — già bocciato 27 volte 6h fa (si riprova fra 6h o quando i dati crescono)
