...
*2026-09-12 01:43 UTC · 6 segnali nuovi messi alla prova su 340 token*
...
| `buy_medio x drawdown_pre (filtro)` | quanto compra in media ciascuno MOLTIPLICATO per quanto è già sceso dal massimo prima di entrare | **-58%** | **+39 punti** |
...
| `buy_medio x drawdown_pre (filtro)` | quanto compra in media ciascuno MOLTIPLICATO per quanto è già sceso dal massimo prima di entrare | -58% (+39) |
...
- `n_compratori (filtro)` — già bocciato 27 volte 5h fa (si riprova fra 7h o quando i dati crescono)
- `buy_medio (voto)` — già bocciato 27 volte 5h fa (si riprova fra 7h o quando i dati crescono)
- `buy_medio (filtro)` — già bocciato 27 volte 5h fa (si riprova fra 7h o quando i dati crescono)
- `buy_grossi (voto)` — già bocciato 27 volte 4h fa (si riprova fra 8h o quando i dati crescono)
- `buy_grossi (filtro)` — già bocciato 27 volte 4h fa (si riprova fra 8h o quando i dati crescono)
