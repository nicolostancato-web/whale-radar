...
*2026-09-11 22:54 UTC · 11 segnali nuovi messi alla prova su 340 token*
...
| `concentrazione_top5 x n_compratori (voto)` | quanto del denaro iniziale arriva dai 5 compratori più grossi MOLTIPLICATO per quante persone diverse hanno comprato | -96% (+1) |
| `concentrazione_top5 / n_compratori (voto)` | quanto del denaro iniziale arriva dai 5 compratori più grossi RAPPORTATO a quante persone diverse hanno comprato | -96% (+0) |
| `concentrazione_top5 x n_compratori (filtro)` | quanto del denaro iniziale arriva dai 5 compratori più grossi MOLTIPLICATO per quante persone diverse hanno comprato | -98% (-1) |
| `concentrazione_top5 / n_compratori (filtro)` | quanto del denaro iniziale arriva dai 5 compratori più grossi RAPPORTATO a quante persone diverse hanno comprato | -98% (-1) |
...
- `n_compratori (voto)` — già bocciato 27 volte 3h fa (si riprova fra 9h o quando i dati crescono)
- `n_compratori (filtro)` — già bocciato 27 volte 3h fa (si riprova fra 9h o quando i dati crescono)
- `buy_medio (voto)` — già bocciato 27 volte 3h fa (si riprova fra 9h o quando i dati crescono)
- `buy_medio (filtro)` — già bocciato 27 volte 3h fa (si riprova fra 9h o quando i dati crescono)
- `buy_grossi (voto)` — già bocciato 27 volte 2h fa (si riprova fra 10h o quando i dati crescono)
