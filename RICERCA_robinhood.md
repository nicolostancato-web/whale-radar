...
*2026-09-15 14:02 UTC · 37 segnali nuovi messi alla prova su 340 token*
...
| `compra_e_rivende x sbilanciamento (voto)` | quanti di quelli che hanno comprato stanno già rivendendo MOLTIPLICATO per quanto il denaro che entra supera quello che esce | -96% (+0) |
| `compra_e_rivende / sbilanciamento (voto)` | quanti di quelli che hanno comprato stanno già rivendendo RAPPORTATO a quanto il denaro che entra supera quello che esce | -96% (+0) |
...
| `n_compratori x buy_grossi (voto)` | quante persone diverse hanno comprato MOLTIPLICATO per la quota di denaro che arriva da acquisti sopra i 500 dollari | -96% (+0) |
| `n_compratori / buy_grossi (voto)` | quante persone diverse hanno comprato RAPPORTATO a la quota di denaro che arriva da acquisti sopra i 500 dollari | -96% (+0) |
| `quota_wallet_reduci x volume_ultima_su_media (voto)` | la quota di denaro che arriva da wallet già visti in ALTRI token andati bene (insider) MOLTIPLICATO per se il volume sta accelerando proprio adesso | -96% (+0) |
| `quota_wallet_reduci / volume_ultima_su_media (voto)` | la quota di denaro che arriva da wallet già visti in ALTRI token andati bene (insider) RAPPORTATO a se il volume sta accelerando proprio adesso | -96% (+0) |
...
| `compra_e_rivende x sbilanciamento (filtro)` | quanti di quelli che hanno comprato stanno già rivendendo MOLTIPLICATO per quanto il denaro che entra supera quello che esce | -97% (-1) |
...
| `quota_wallet_vincenti x usd_primi20 (filtro)` | la quota di denaro da wallet con almeno un successo alle spalle MOLTIPLICATO per quanto pesano i primissimi 20 acquisti sul totale | -97% (-1) |
| `quota_wallet_vincenti / usd_primi20 (filtro)` | la quota di denaro da wallet con almeno un successo alle spalle RAPPORTATO a quanto pesano i primissimi 20 acquisti sul totale | -97% (-1) |
| `compra_e_rivende / sbilanciamento (filtro)` | quanti di quelli che hanno comprato stanno già rivendendo RAPPORTATO a quanto il denaro che entra supera quello che esce | -97% (-1) |
| `quota_wallet_nuovi x usd_primi20 (filtro)` | la quota di denaro da wallet mai visti prima MOLTIPLICATO per quanto pesano i primissimi 20 acquisti sul totale | -97% (-1) |
| `quota_wallet_nuovi / usd_primi20 (filtro)` | la quota di denaro da wallet mai visti prima RAPPORTATO a quanto pesano i primissimi 20 acquisti sul totale | -97% (-1) |
...
| `quota_wallet_nuovi x volume_ultima_su_media (filtro)` | la quota di denaro da wallet mai visti prima MOLTIPLICATO per se il volume sta accelerando proprio adesso | -97% (-1) |
| `quota_wallet_nuovi / volume_ultima_su_media (filtro)` | la quota di denaro da wallet mai visti prima RAPPORTATO a se il volume sta accelerando proprio adesso | -97% (-1) |
...
| `n_compratori x buy_grossi (filtro)` | quante persone diverse hanno comprato MOLTIPLICATO per la quota di denaro che arriva da acquisti sopra i 500 dollari | -97% (-1) |
| `n_compratori / buy_grossi (filtro)` | quante persone diverse hanno comprato RAPPORTATO a la quota di denaro che arriva da acquisti sopra i 500 dollari | -97% (-1) |
| `quota_wallet_reduci x volume_ultima_su_media (filtro)` | la quota di denaro che arriva da wallet già visti in ALTRI token andati bene (insider) MOLTIPLICATO per se il volume sta accelerando proprio adesso | -97% (-1) |
| `quota_wallet_reduci / volume_ultima_su_media (filtro)` | la quota di denaro che arriva da wallet già visti in ALTRI token andati bene (insider) RAPPORTATO a se il volume sta accelerando proprio adesso | -97% (-1) |
