...
*2026-09-16 02:33 UTC · aggiornato da solo a ogni giro*
...
- 🟢 vive: motore (2′), ricerca (0′), loop 0 (10′), sperimenti (5′)
...
- 🔴 **Tace da 115 ore** (dovrebbe parlare due volte al giorno).
...
|---|---|---|
| base/COMPLETI (prezzo+scambi) | 1,038 | **+12** |
| base/DOMANDABILI (stima %) | 14 | — |
| base/battito | 3,318 | — |
| base/candele | 1,543 | **+13** |
| robinhood/COMPLETI (prezzo+scambi) | 976 | **+8** |
| robinhood/DOMANDABILI (stima %) | 2 | — |
| robinhood/battito | 242 | — |
| robinhood/candele | 2,404 | **+19** |
| robinhood/toccati 12h | 93 | **+9** |
...
*Calcolato alle **02:33 UTC** del 16/09/2026.*