...
*2026-09-15 12:28 UTC · aggiornato da solo a ogni giro*
...
- 🟢 vive: motore (6′), ricerca (3′), loop 0 (6′), sperimenti (6′)
...
|---|---|---|
| base/COMPLETI (prezzo+scambi) | 941 | — |
| base/DOMANDABILI (stima %) | 13 | — |
| base/battito | 3,280 | **+10** |
| base/candele | 1,439 | — |
| robinhood/COMPLETI (prezzo+scambi) | 696 | — |
| robinhood/DOMANDABILI (stima %) | 3 | — |
| robinhood/battito | 213 | **+3** |
| robinhood/candele | 1,996 | — |
| robinhood/toccati 12h | 103 | — |
| solana/COMPLETI (prezzo+scambi) | 930 | — |
| solana/DOMANDABILI (stima %) | 12 | — |
| solana/battito | 196 | — |
...
*Calcolato alle **12:28 UTC** del 15/09/2026.*