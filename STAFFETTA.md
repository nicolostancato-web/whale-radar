...
*2026-09-15 14:16 UTC · aggiornato da solo a ogni giro*
...
- 🟢 vive: ricerca (3′), loop 0 (9′), sperimenti (7′)
...
|---|---|---|
| base/COMPLETI (prezzo+scambi) | 972 | **+9** |
| base/DOMANDABILI (stima %) | 15 | — |
| base/battito | 3,301 | — |
| base/candele | 1,439 | — |
| robinhood/COMPLETI (prezzo+scambi) | 746 | **+6** |
| robinhood/DOMANDABILI (stima %) | 3 | **+2** |
| robinhood/battito | 222 | — |
| robinhood/candele | 2,038 | — |
| robinhood/toccati 12h | 114 | — |
| solana/COMPLETI (prezzo+scambi) | 959 | **+3** |
...
*Calcolato alle **14:16 UTC** del 15/09/2026.*