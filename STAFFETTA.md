...
*2026-09-16 01:02 UTC · aggiornato da solo a ogni giro*
...
- 🟢 vive: motore (8′), ricerca (3′), loop 0 (9′), sperimenti (5′)
...
| base/battito | 3,318 | — |
| base/candele | 1,530 | — |
| robinhood/COMPLETI (prezzo+scambi) | 941 | **+8** |
| robinhood/DOMANDABILI (stima %) | 2 | — |
| robinhood/battito | 239 | — |
| robinhood/candele | 2,362 | **+20** |
| robinhood/toccati 12h | 113 | **+11** |
| solana/COMPLETI (prezzo+scambi) | 1,138 | **+9** |
...
*Calcolato alle **01:02 UTC** del 16/09/2026.*