...
*2026-09-15 11:04 UTC · aggiornato da solo a ogni giro*
...
- 🟢 vive: motore (2′), ricerca (9′), loop 0 (11′), sperimenti (4′)
...
- 🔴 **Tace da 99 ore** (dovrebbe parlare due volte al giorno).
...
|---|---|---|
| base/COMPLETI (prezzo+scambi) | 943 | — |
| base/DOMANDABILI (stima %) | 13 | — |
| base/battito | 3,270 | — |
| base/candele | 2,005 | — |
| robinhood/COMPLETI (prezzo+scambi) | 703 | — |
| robinhood/DOMANDABILI (stima %) | 3 | — |
| robinhood/battito | 210 | — |
| robinhood/candele | 4,613 | — |
| robinhood/toccati 12h | 94 | — |
| solana/COMPLETI (prezzo+scambi) | 1,057 | — |
| solana/DOMANDABILI (stima %) | 10 | — |
| solana/battito | 196 | — |
| solana/candele | 1,774 | — |
...
*Calcolato alle **11:04 UTC** del 15/09/2026.*