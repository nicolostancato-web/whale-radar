...
*2026-09-16 00:22 UTC · aggiornato da solo a ogni giro*
...
- 🟢 vive: motore (21′), ricerca (3′), loop 0 (14′), sperimenti (4′)
...
- 🔴 **Tace da 113 ore** (dovrebbe parlare due volte al giorno).
...
| base/battito | 3,318 | — |
| base/candele | 1,530 | — |
| robinhood/COMPLETI (prezzo+scambi) | 924 | **+6** |
| robinhood/DOMANDABILI (stima %) | 2 | **+2** |
| robinhood/battito | 239 | — |
| robinhood/candele | 2,342 | — |
...
*Calcolato alle **00:22 UTC** del 16/09/2026.*