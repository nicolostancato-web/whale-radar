...
*2026-09-15 19:20 UTC · aggiornato da solo a ogni giro*
...
- 🟢 vive: motore (24′), ricerca (2′), loop 0 (13′), sperimenti (6′)
...
- 🔴 **Tace da 108 ore** (dovrebbe parlare due volte al giorno).
...
| base/battito | 3,309 | — |
| base/candele | 1,510 | — |
| robinhood/COMPLETI (prezzo+scambi) | 816 | **+4** |
| robinhood/DOMANDABILI (stima %) | 0 | — |
| robinhood/battito | 228 | — |
| robinhood/candele | 2,224 | — |
...
*Calcolato alle **19:20 UTC** del 15/09/2026.*