...
*2026-09-15 23:38 UTC · aggiornato da solo a ogni giro*
...
- 🟢 vive: motore (20′), ricerca (2′), loop 0 (0′), sperimenti (4′)
...
|---|---|---|
| base/COMPLETI (prezzo+scambi) | 1,022 | **+9** |
| base/DOMANDABILI (stima %) | 14 | **+1** |
| base/battito | 3,318 | — |
| base/candele | 1,530 | — |
...
*Calcolato alle **23:38 UTC** del 15/09/2026.*