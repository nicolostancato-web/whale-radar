...
*2026-09-05 18:20 UTC · 527 osservazioni · 53 nel decile alto · 33274 entità riconosciute*
...
|---|---|---|---|---|
| 5 min | **+2.8%** | +0.0% | 26% | 53 |
| 30 min | **+2.8%** | +0.0% | 26% | 53 |
| 2 ore | **+21.4%** | +0.4% | 58% | 53 |
| 6 ore | **+0.2%** | +0.2% | 53% | 49 |
| 24 ore | **-249.1%** | +0.1% | 53% | 45 |
...
> 🔴 **Il segnale arriva a festa cominciata.** Nelle 2 ore PRIMA il token aveva già
> fatto **+264%**; nelle 2 ore DOPO fa **+21.4%**. Non stiamo prevedendo
...
### Lo stesso segnale, ma solo dove il rialzo NON era già avvenuto
...
> ⏸️ **Non ancora giudicabile**: la fascia di validazione non ha abbastanza casi, e il
> criterio di morte non scatta su dati insufficienti.
> In ricerca il flusso alto batte i controlli su 4 orizzonti su 5,
