...
*2026-09-11 22:40 UTC · giro 3*

| esperimento | esito | ultima cosa detta |
|---|---|---|
| `liquidita_impegnata.py` | ok | LIQUIDITA_IMPEGNATA | eventi:268 |
| `sperimentale.py` | ok | SPERIMENTALE | gemelli 2496 | esplosioni 41 | valutate 33 |
| `due_gambe.py` | ok | DUE_GAMBE | copertura base:7% robinhood:3% solana:56% |
| `costo_chain.py` | ok | COSTO_CHAIN | controllo su solana: NON passa |
| `costo_evm.py` | ok | COSTO_EVM | base:2misure robinhood:20misure |
| `ritardo.py` | ok | RITARDO | base:542 robinhood:492 solana:623 |
