...
*2026-09-12 00:18 UTC · giro 22*

| esperimento | esito | ultima cosa detta |
|---|---|---|
| `liquidita_impegnata.py` | ok | LIQUIDITA_IMPEGNATA | eventi:268 |
| `sperimentale.py` | ok | SPERIMENTALE | gemelli 2500 | esplosioni 41 | valutate 33 |
...
| `ritardo.py` | ok | RITARDO | base:546 robinhood:494 solana:623 |
