...
*2026-09-16 01:51 UTC · giro 13*

| esperimento | esito | ultima cosa detta |
|---|---|---|
| `liquidita_impegnata.py` | ok | LIQUIDITA_IMPEGNATA | eventi:304 |
| `sperimentale.py` | ok | SPERIMENTALE | gemelli 2529 | esplosioni 34 | valutate 24 |
...
| `esaurimento.py` | ok | ESAURIMENTO | dentro:126 controlli:4000 |
| `coorte.py` | ok | COORTE | 31 nuove, 869 totali |
