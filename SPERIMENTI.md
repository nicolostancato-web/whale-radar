...
*2026-09-12 07:42 UTC · giro 13*

| esperimento | esito | ultima cosa detta |
|---|---|---|
| `liquidita_impegnata.py` | ok | LIQUIDITA_IMPEGNATA | eventi:270 |
| `sperimentale.py` | ok | SPERIMENTALE | gemelli 2518 | esplosioni 34 | valutate 27 |
| `due_gambe.py` | ok | DUE_GAMBE | copertura base:7% robinhood:4% solana:54% |
| `costo_chain.py` | ok | COSTO_CHAIN | controllo su solana: NON passa |
| `costo_evm.py` | ok | COSTO_EVM | base:2misure robinhood:24misure |
| `ritardo.py` | ok | RITARDO | base:551 robinhood:496 solana:611 |
