...
*2026-09-12 10:45 UTC · giro 53*

| esperimento | esito | ultima cosa detta |
|---|---|---|
| `liquidita_impegnata.py` | ok | LIQUIDITA_IMPEGNATA | eventi:271 |
| `sperimentale.py` | ok | SPERIMENTALE | gemelli 2523 | esplosioni 34 | valutate 25 |
...
| `ritardo.py` | ok | RITARDO | base:551 robinhood:498 solana:607 |
