...
*2026-09-12 14:33 UTC · giro 44*

| esperimento | esito | ultima cosa detta |
|---|---|---|
| `liquidita_impegnata.py` | ok | LIQUIDITA_IMPEGNATA | eventi:273 |
| `sperimentale.py` | ok | SPERIMENTALE | gemelli 2541 | esplosioni 33 | valutate 24 |
...
| `costo_evm.py` | ok | COSTO_EVM | base:1misure robinhood:22misure |
| `ritardo.py` | ok | RITARDO | base:556 robinhood:498 solana:606 |
