...
*2026-09-12 17:10 UTC · giro 29*

| esperimento | esito | ultima cosa detta |
|---|---|---|
| `liquidita_impegnata.py` | ok | LIQUIDITA_IMPEGNATA | eventi:273 |
| `sperimentale.py` | ok | SPERIMENTALE | gemelli 2553 | esplosioni 33 | valutate 24 |
...
| `costo_evm.py` | ok | COSTO_EVM | base:3misure robinhood:19misure |
