...
*2026-09-12 04:25 UTC · giro 24*

| esperimento | esito | ultima cosa detta |
|---|---|---|
| `liquidita_impegnata.py` | ok | LIQUIDITA_IMPEGNATA | eventi:268 |
| `sperimentale.py` | ok | SPERIMENTALE | gemelli 2502 | esplosioni 38 | valutate 30 |
...
| `costo_evm.py` | ok | COSTO_EVM | base:1misure robinhood:27misure |
| `ritardo.py` | ok | RITARDO | base:549 robinhood:495 solana:613 |
