...
*2026-09-17 19:10 UTC · esperimento 4 · solo dati già scaricati · €0*
...
**Esaurimenti trovati: 135** · controlli (stessi giorni, senza scarico): 4000

| | eventi | mediana netta 6h | media netta |
|---|---|---|---|
| **dopo l'esaurimento** | 135 | **-2.4%** | +0.5% |
| controllo (niente scarico) | 4000 | -1.5% | +132547.8% |

Limite inferiore dell'intervallo al 95%, contando **17 giorni** e non le righe: **-7.9%**.

## Verdetto

> ❌ **Criterio di morte scattato**, scritto prima di guardare: il limite inferiore
> al 95% è **-7.9%**, non sopra zero. Non si alza la dominanza a 2×, non si
> sposta l'esito a 2h: sarebbe scegliere la soglia dopo aver visto il risultato.

*metro=VERO (misurato) · curva liquidità ATTIVA · entrata 1.6% · uscita a target 1.9% · uscita in fuga 13.2% · pareggio 1.15x (in fuga 1.30x)*