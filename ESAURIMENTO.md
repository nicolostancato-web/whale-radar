...
*2026-09-16 02:33 UTC · esperimento 4 · solo dati già scaricati · €0*
...
**Esaurimenti trovati: 126** · controlli (stessi giorni, senza scarico): 4000

| | eventi | mediana netta 6h | media netta |
|---|---|---|---|
| **dopo l'esaurimento** | 126 | **-2.6%** | +0.5% |
| controllo (niente scarico) | 4000 | -1.7% | +132311.8% |

Limite inferiore dell'intervallo al 95%, contando **15 giorni** e non le righe: **-8.6%**.

## Verdetto

> ❌ **Criterio di morte scattato**, scritto prima di guardare: il limite inferiore
> al 95% è **-8.6%**, non sopra zero. Non si alza la dominanza a 2×, non si
> sposta l'esito a 2h: sarebbe scegliere la soglia dopo aver visto il risultato.

*metro=VERO (misurato) · curva liquidità ATTIVA · entrata 1.3% · uscita a target 2.1% · uscita in fuga 14.7% · pareggio 1.15x (in fuga 1.32x)*