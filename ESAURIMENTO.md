...
*2026-09-12 14:47 UTC · esperimento 4 · solo dati già scaricati · €0*
...
|---|---|---|---|
| **dopo l'esaurimento** | 116 | **-3.5%** | +0.8% |
| controllo (niente scarico) | 4000 | -1.3% | +139947.8% |

Limite inferiore dell'intervallo al 95%, contando **12 giorni** e non le righe: **-8.3%**.

## Verdetto

> ❌ **Criterio di morte scattato**, scritto prima di guardare: il limite inferiore
> al 95% è **-8.3%**, non sopra zero. Non si alza la dominanza a 2×, non si
> sposta l'esito a 2h: sarebbe scegliere la soglia dopo aver visto il risultato.

*metro=VERO (misurato) · curva liquidità ATTIVA · entrata 1.6% · uscita a target 1.6% · uscita in fuga 12.2% · pareggio 1.15x (in fuga 1.28x)*