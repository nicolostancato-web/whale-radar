...
# TRE chain, non quattro (08/09, decisione del fondatore). BSC era la peggiore (-31%) e soprattutto
# e' un doppione: stessa natura EVM di Base. Base, Solana e Robinhood sono tre mondi DIVERSI, e il
# tool che fa soldi potrebbe esistere in uno solo di quei tre — cercarlo in un doppione costa un
# quarto della capacita' e non aggiunge una possibilita' nuova.
# NON cancelliamo i dati di BSC e resta misurata in percentuale.py: continuiamo a sapere il suo
# numero senza spenderci sopra dei giri di ricerca. Smettere di cercare non e' smettere di guardare.
