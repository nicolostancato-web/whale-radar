...
*2026-09-12 07:51 UTC · ritardo reale applicato: 1382 minuti · €0*
...
| | token |
|---|---|
| **acquistabili** all'ingresso (filtri passati con i dati di allora) | **620** |
| ...di cui **arrivati a un esito misurabile** | **223** |
| ...**mancanti dal conto** | **397** (64%) |

**Perché mancano:**

- poche candele dopo l'ingresso: 99
- mai arrivato al volume minimo: 443
- sparito subito: 298

## Cosa avrebbero reso, se li contassimo

Per 211 dei mancanti conosciamo comunque un prezzo di uscita:
rendimento medio **-5%**, mediano **-8%**.
...
> ⚠️ **Il 64% degli acquisti che avremmo fatto non compare nel rendimento.**
