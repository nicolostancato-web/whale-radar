...
*2026-09-11 21:00 UTC · ritardo reale applicato: 222 minuti · €0*
...
| | token |
|---|---|
| **acquistabili** all'ingresso (filtri passati con i dati di allora) | **1736** |
| ...di cui **arrivati a un esito misurabile** | **231** |
| ...**mancanti dal conto** | **1505** (86%) |

**Perché mancano:**

- poche candele dopo l'ingresso: 153
- mai arrivato al volume minimo: 2957
- sparito subito: 1352

## Cosa avrebbero reso, se li contassimo

Per 340 dei mancanti conosciamo comunque un prezzo di uscita:
rendimento medio **+26191283370%**, mediano **-4%**.
...
> ⚠️ **Il 87% degli acquisti che avremmo fatto non compare nel rendimento.**
