...
*2026-09-17 18:36 UTC · nato dalla revisione esterna dell'11/09 · sola lettura · €0*
...
|---|---|---|---|---|---|
| **base** | 586 | **+0.1%** | +0.0% | -0.1% | -0.0% |
| **robinhood** | 565 | **-4.1%** | -0.4% | -1.5% | -7.2% |
| **solana** | 642 | **-2.2%** | -0.0% | -1.1% | -3.0% |
...
> prezzo ha già fatto **+0.1%**; da quando compriamo in poi fa
> **-0.1%**. Il movimento c'è — **ma lo incassa qualcun altro**.
...
> **+0.1%** prima che potessimo entrare e **-0.2%** dopo.
