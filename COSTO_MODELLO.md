...
*2026-09-17 16:12 UTC · 2790 token misurati su Jupiter · €0*
...
|---|---|---|---|---|
| $25 | **41%** (1142/2782) | **4.0%** | 5% | 1.04x |
| $100 | **42%** (1158/2733) | **8.4%** | 10% | 1.09x |
| $500 | **45%** (1211/2676) | **26.3%** | 27% | 1.36x |
...
Ma **41%** dei token è una **trappola**: o non c'è uscita, o l'uscita restituisce nulla.
Quella non è una percentuale di costo: è tutto il capitale.

Messe insieme: un trade che riesce deve fare almeno **1.77x** perché il gruppo
