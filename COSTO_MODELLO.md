...
*2026-09-05 09:51 UTC · 1054 token misurati su Jupiter · €0*
...
|---|---|---|---|---|
| $25 | **23%** (246/1054) | **4.0%** | 5% | 1.04x |
| $100 | **25%** (262/1035) | **8.2%** | 10% | 1.09x |
| $500 | **30%** (302/1016) | **25.7%** | 30% | 1.35x |
...
Ma **23%** dei token è una **trappola**: o non c'è uscita, o l'uscita restituisce nulla.
Quella non è una percentuale di costo: è tutto il capitale.

Messe insieme: un trade che riesce deve fare almeno **1.36x** perché il gruppo
