...
*2026-09-05 21:08 UTC · 1120 token misurati su Jupiter · €0*
...
|---|---|---|---|---|
| $25 | **25%** (282/1119) | **4.0%** | 5% | 1.04x |
| $100 | **27%** (299/1102) | **8.2%** | 10% | 1.09x |
| $500 | **32%** (341/1081) | **25.7%** | 30% | 1.35x |
...
Ma **25%** dei token è una **trappola**: o non c'è uscita, o l'uscita restituisce nulla.
Quella non è una percentuale di costo: è tutto il capitale.

Messe insieme: un trade che riesce deve fare almeno **1.39x** perché il gruppo
