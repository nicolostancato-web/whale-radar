...
*2026-09-12 11:24 UTC · 1867 token misurati su Jupiter · €0*
...
|---|---|---|---|---|
| $25 | **35%** (658/1863) | **4.0%** | 5% | 1.04x |
| $100 | **37%** (673/1830) | **8.3%** | 10% | 1.09x |
| $500 | **40%** (721/1790) | **26.1%** | 28% | 1.35x |
...
Ma **35%** dei token è una **trappola**: o non c'è uscita, o l'uscita restituisce nulla.
Quella non è una percentuale di costo: è tutto il capitale.

Messe insieme: un trade che riesce deve fare almeno **1.61x** perché il gruppo
