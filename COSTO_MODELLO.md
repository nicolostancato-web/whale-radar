...
*2026-09-05 22:08 UTC · 1135 token misurati su Jupiter · €0*
...
|---|---|---|---|---|
| $25 | **26%** (291/1134) | **4.0%** | 5% | 1.04x |
| $100 | **28%** (308/1117) | **8.2%** | 10% | 1.09x |
| $500 | **32%** (352/1095) | **25.7%** | 30% | 1.35x |
...
Ma **26%** dei token è una **trappola**: o non c'è uscita, o l'uscita restituisce nulla.
Quella non è una percentuale di costo: è tutto il capitale.

Messe insieme: un trade che riesce deve fare almeno **1.40x** perché il gruppo
