...
*2026-09-12 12:30 UTC · 1873 token misurati su Jupiter · €0*
...
|---|---|---|---|---|
| $25 | **36%** (664/1869) | **4.0%** | 5% | 1.04x |
| $100 | **37%** (677/1835) | **8.3%** | 10% | 1.09x |
| $500 | **40%** (727/1797) | **26.0%** | 28% | 1.35x |
...
Ma **36%** dei token è una **trappola**: o non c'è uscita, o l'uscita restituisce nulla.
Quella non è una percentuale di costo: è tutto il capitale.

Messe insieme: un trade che riesce deve fare almeno **1.62x** perché il gruppo
