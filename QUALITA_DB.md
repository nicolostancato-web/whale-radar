...
*2026-09-15 18:54 UTC · controllo continuo · €0*
...
| robinhood: freschezza | 🔴 **FALLISCE** | 40.2 | il dato piu' recente nel campione ha 40.2 ore (letto DENTRO i file, non dalla data del file) |
...
| solana: freschezza | 🟡 **ATTENZIONE** | 21.1 | il dato piu' recente nel campione ha 21.1 ore (letto DENTRO i file, non dalla data del file) |
