...
*2026-09-16 01:14 UTC · controllo continuo · €0*
...
| robinhood: scambi orfani | 🔴 **FALLISCE** | 81.3 | 4083 file su 5024 non si uniscono a nessuna serie di prezzo |
...
| robinhood: serie con scambi | 🟡 **ATTENZIONE** | 37.3 | 941 su 2524 |
| solana: freschezza | 🟡 **ATTENZIONE** | 9.9 | il dato piu' recente nel campione ha 9.9 ore (letto DENTRO i file, non dalla data del file) |
...
| base: storico utile | 🟢 **PASSA** | 93.7 | sulle righe COPERTE: 281 su 300 hanno almeno 6 scambi prima dell'entrata |
...
| robinhood: freschezza | 🟢 **PASSA** | 4.4 | il dato piu' recente nel campione ha 4.4 ore (letto DENTRO i file, non dalla data del file) |
...
| robinhood: storico, quante righe copre | 🟢 **PASSA** | 68.4 | 525 righe su 767 hanno la storia dalla catena |
