...
*2026-09-15 23:33 UTC · controllo continuo · €0*
...
| robinhood: scambi orfani | 🔴 **FALLISCE** | 81.9 | 4083 file su 4984 non si uniscono a nessuna serie di prezzo |
| solana: feature scambi vive | 🔴 **FALLISCE** | 16.1 | solo 124 righe su 770 hanno scambi veri; le altre usano il valore di ripiego |
...
| robinhood: freschezza | 🟡 **ATTENZIONE** | 24.0 | il dato piu' recente nel campione ha 24.0 ore (letto DENTRO i file, non dalla data del file) |
| robinhood: serie con scambi | 🟡 **ATTENZIONE** | 36.3 | 901 su 2483 |
| solana: freschezza | 🟡 **ATTENZIONE** | 8.2 | il dato piu' recente nel campione ha 8.2 ore (letto DENTRO i file, non dalla data del file) |
...
| base: storico utile | 🟢 **PASSA** | 92.0 | sulle righe COPERTE: 276 su 300 hanno almeno 6 scambi prima dell'entrata |
