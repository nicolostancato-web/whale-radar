...
*2026-09-26 18:29 UTC · controllo continuo · €0*
...
| base: freschezza | 🔴 **FALLISCE** | 114.2 | il dato piu' recente nel campione ha 114.2 ore (letto DENTRO i file, non dalla data del file) |
...
| robinhood: freschezza | 🔴 **FALLISCE** | 134.2 | il dato piu' recente nel campione ha 134.2 ore (letto DENTRO i file, non dalla data del file) |
...
| solana: freschezza | 🔴 **FALLISCE** | 222.2 | il dato piu' recente nel campione ha 222.2 ore (letto DENTRO i file, non dalla data del file) |
...
| robinhood: timbro di acquisizione | 🟡 **ATTENZIONE** | 30.0 | 3 file su 10 fra i piu' recenti hanno il campo acq |
...
| base: storico dalla catena | 🟢 **PASSA** | 18187 | 18187 pool con storia dalla catena |
...
| robinhood: storico dalla catena | 🟢 **PASSA** | 27817 | 27817 pool con storia dalla catena |
