...
*2026-09-19 13:41 UTC · controllo continuo · €0*
...
| base: freschezza | 🔴 **FALLISCE** | 39.2 | il dato piu' recente nel campione ha 39.2 ore (letto DENTRO i file, non dalla data del file) |
...
| solana: freschezza | 🔴 **FALLISCE** | 43.8 | il dato piu' recente nel campione ha 43.8 ore (letto DENTRO i file, non dalla data del file) |
...
| base: timbro di acquisizione | 🟡 **ATTENZIONE** | 0.0 | 0 file su 1 fra i piu' recenti hanno il campo acq |
