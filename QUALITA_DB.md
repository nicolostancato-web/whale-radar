...
*2026-09-15 13:46 UTC · controllo continuo · €0*
...
| base: freschezza | 🔴 **FALLISCE** | 47.8 | il dato piu' recente nel campione ha 47.8 ore (letto DENTRO i file, non dalla data del file) |
...
| robinhood: scambi orfani | 🔴 **FALLISCE** | 84.7 | 4083 file su 4821 non si uniscono a nessuna serie di prezzo |
| solana: feature scambi vive | 🔴 **FALLISCE** | 16.3 | solo 124 righe su 762 hanno scambi veri; le altre usano il valore di ripiego |
| solana: scambi orfani | 🔴 **FALLISCE** | 76.5 | 3093 file su 4043 non si uniscono a nessuna serie di prezzo |
| base: scambi orfani | 🟡 **ATTENZIONE** | 40.8 | 663 file su 1626 non si uniscono a nessuna serie di prezzo |
| robinhood: serie con scambi | 🟡 **ATTENZIONE** | 33.9 | 738 su 2176 |
| solana: freschezza | 🟡 **ATTENZIONE** | 11.8 | il dato piu' recente nel campione ha 11.8 ore (letto DENTRO i file, non dalla data del file) |
| solana: timbro di acquisizione | 🟡 **ATTENZIONE** | 0.0 | 0 file su 13 fra i piu' recenti hanno il campo acq |
...
| robinhood: freschezza | 🟢 **PASSA** | 2.6 | il dato piu' recente nel campione ha 2.6 ore (letto DENTRO i file, non dalla data del file) |
| robinhood: storico dalla catena | 🟢 **PASSA** | 783 | 783 pool con storia dalla catena |
| robinhood: storico utile | 🟢 **PASSA** | 67.7 | sulle righe COPERTE: 203 su 300 hanno almeno 6 scambi prima dell'entrata |
| robinhood: storico, quante righe copre | 🟢 **PASSA** | 66.1 | 499 righe su 755 hanno la storia dalla catena |
...
| solana: serie con scambi | 🟢 **PASSA** | 68.8 | 950 su 1380 |
