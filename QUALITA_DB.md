...
*2026-09-19 17:34 UTC · controllo continuo · €0*
...
| base: freschezza | 🔴 **FALLISCE** | 39.7 | il dato piu' recente nel campione ha 39.7 ore (letto DENTRO i file, non dalla data del file) |
...
| solana: freschezza | 🔴 **FALLISCE** | 47.6 | il dato piu' recente nel campione ha 47.6 ore (letto DENTRO i file, non dalla data del file) |
| solana: scambi orfani | 🔴 **FALLISCE** | 65.3 | 3093 file su 4734 non si uniscono a nessuna serie di prezzo |
| base: scambi orfani | 🟡 **ATTENZIONE** | 30.6 | 663 file su 2168 non si uniscono a nessuna serie di prezzo |
| base: serie con scambi | 🟡 **ATTENZIONE** | 30.5 | 1505 su 4934 |
...
| base: storico dalla catena | 🟢 **PASSA** | 11300 | 11300 pool con storia dalla catena |
...
| robinhood: storico dalla catena | 🟢 **PASSA** | 3666 | 3666 pool con storia dalla catena |
