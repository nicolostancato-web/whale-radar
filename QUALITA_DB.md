...
*2026-09-16 00:06 UTC · controllo continuo · €0*
...
| robinhood: scambi orfani | 🔴 **FALLISCE** | 81.8 | 4083 file su 4992 non si uniscono a nessuna serie di prezzo |
...
| robinhood: serie con scambi | 🟡 **ATTENZIONE** | 36.6 | 909 su 2485 |
| solana: freschezza | 🟡 **ATTENZIONE** | 8.8 | il dato piu' recente nel campione ha 8.8 ore (letto DENTRO i file, non dalla data del file) |
...
| base: storico utile | 🟢 **PASSA** | 92.3 | sulle righe COPERTE: 277 su 300 hanno almeno 6 scambi prima dell'entrata |
...
| robinhood: storico, quante righe copre | 🟢 **PASSA** | 68.4 | 525 righe su 768 hanno la storia dalla catena |
