...
*2026-09-19 11:43 UTC · controllo continuo · €0*
...
| solana: freschezza | 🔴 **FALLISCE** | 41.8 | il dato piu' recente nel campione ha 41.8 ore (letto DENTRO i file, non dalla data del file) |
| solana: scambi orfani | 🔴 **FALLISCE** | 65.3 | 3093 file su 4734 non si uniscono a nessuna serie di prezzo |
| base: scambi orfani | 🟡 **ATTENZIONE** | 30.8 | 663 file su 2154 non si uniscono a nessuna serie di prezzo |
| base: serie con scambi | 🟡 **ATTENZIONE** | 30.2 | 1491 su 4934 |
| base: timbro di acquisizione | 🟡 **ATTENZIONE** | 0.0 | 0 file su 6 fra i piu' recenti hanno il campo acq |
| robinhood: freschezza | 🟡 **ATTENZIONE** | 8.0 | il dato piu' recente nel campione ha 8.0 ore (letto DENTRO i file, non dalla data del file) |
...
| base: freschezza | 🟢 **PASSA** | 0.5 | il dato piu' recente nel campione ha 0.5 ore (letto DENTRO i file, non dalla data del file) |
