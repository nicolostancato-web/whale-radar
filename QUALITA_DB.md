...
*2026-09-15 15:15 UTC · controllo continuo · €0*
...
| robinhood: storico utile | 🔴 **FALLISCE** | 16.0 | sulle righe COPERTE: 48 su 300 hanno almeno 6 scambi prima dell'entrata |
...
| robinhood: freschezza | 🟡 **ATTENZIONE** | 6.9 | il dato piu' recente nel campione ha 6.9 ore (letto DENTRO i file, non dalla data del file) |
| robinhood: serie con scambi | 🟡 **ATTENZIONE** | 33.7 | 749 su 2221 |
| solana: freschezza | 🟡 **ATTENZIONE** | 10.0 | il dato piu' recente nel campione ha 10.0 ore (letto DENTRO i file, non dalla data del file) |
...
| base: storico dalla catena | 🟢 **PASSA** | 4489 | 4489 pool con storia dalla catena |
| base: storico utile | 🟢 **PASSA** | 82.3 | sulle righe COPERTE: 247 su 300 hanno almeno 6 scambi prima dell'entrata |
| base: storico, quante righe copre | 🟢 **PASSA** | 92.2 | 1761 righe su 1909 hanno la storia dalla catena |
