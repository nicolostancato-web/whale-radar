...
*2026-09-15 14:04 UTC · controllo continuo · €0*
...
| base: serie con scambi | 🔴 **FALLISCE** | 21.6 | 972 su 4490 |
...
| robinhood: scambi orfani | 🔴 **FALLISCE** | 84.6 | 4083 file su 4829 non si uniscono a nessuna serie di prezzo |
| solana: feature scambi vive | 🔴 **FALLISCE** | 16.3 | solo 124 righe su 763 hanno scambi veri; le altre usano il valore di ripiego |
| solana: scambi orfani | 🔴 **FALLISCE** | 76.3 | 3093 file su 4052 non si uniscono a nessuna serie di prezzo |
| base: scambi orfani | 🟡 **ATTENZIONE** | 40.6 | 663 file su 1635 non si uniscono a nessuna serie di prezzo |
| robinhood: serie con scambi | 🟡 **ATTENZIONE** | 33.9 | 746 su 2203 |
| solana: freschezza | 🟡 **ATTENZIONE** | 8.7 | il dato piu' recente nel campione ha 8.7 ore (letto DENTRO i file, non dalla data del file) |
| solana: timbro di acquisizione | 🟡 **ATTENZIONE** | 0.0 | 0 file su 9 fra i piu' recenti hanno il campo acq |
...
| robinhood: freschezza | 🟢 **PASSA** | 3.5 | il dato piu' recente nel campione ha 3.5 ore (letto DENTRO i file, non dalla data del file) |
| robinhood: storico dalla catena | 🟢 **PASSA** | 794 | 794 pool con storia dalla catena |
| robinhood: storico utile | 🟢 **PASSA** | 67.7 | sulle righe COPERTE: 203 su 300 hanno almeno 6 scambi prima dell'entrata |
| robinhood: storico, quante righe copre | 🟢 **PASSA** | 67.5 | 510 righe su 756 hanno la storia dalla catena |
...
| solana: serie con scambi | 🟢 **PASSA** | 69.3 | 959 su 1384 |
