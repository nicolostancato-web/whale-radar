...
*2026-09-15 21:19 UTC · controllo continuo · €0*
...
| base: serie con scambi | 🔴 **FALLISCE** | 21.9 | 996 su 4538 |
...
| base: scambi orfani | 🟡 **ATTENZIONE** | 40.0 | 663 file su 1659 non si uniscono a nessuna serie di prezzo |
| robinhood: serie con scambi | 🟡 **ATTENZIONE** | 35.4 | 858 su 2426 |
| solana: freschezza | 🟡 **ATTENZIONE** | 20.6 | il dato piu' recente nel campione ha 20.6 ore (letto DENTRO i file, non dalla data del file) |
...
| base: freschezza | 🟢 **PASSA** | 5.3 | il dato piu' recente nel campione ha 5.3 ore (letto DENTRO i file, non dalla data del file) |
...
| base: timbro di acquisizione | 🟢 **PASSA** | 66.7 | 16 file su 24 fra i piu' recenti hanno il campo acq |
