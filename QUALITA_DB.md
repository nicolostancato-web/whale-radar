...
*2026-09-19 14:23 UTC · controllo continuo · €0*
...
| base: freschezza | 🔴 **FALLISCE** | 39.9 | il dato piu' recente nel campione ha 39.9 ore (letto DENTRO i file, non dalla data del file) |
...
| solana: freschezza | 🔴 **FALLISCE** | 44.5 | il dato piu' recente nel campione ha 44.5 ore (letto DENTRO i file, non dalla data del file) |
...
| robinhood: timbro di acquisizione | 🟡 **ATTENZIONE** | 16.7 | 3 file su 18 fra i piu' recenti hanno il campo acq |
...
| base: storico dalla catena | 🟢 **PASSA** | 7364 | 7364 pool con storia dalla catena |
...
| robinhood: freschezza | 🟢 **PASSA** | 1.8 | il dato piu' recente nel campione ha 1.8 ore (letto DENTRO i file, non dalla data del file) |
| robinhood: storico dalla catena | 🟢 **PASSA** | 1753 | 1753 pool con storia dalla catena |
