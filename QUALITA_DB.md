...
*2026-09-26 11:01 UTC · controllo continuo · €0*
...
| base: freschezza | 🔴 **FALLISCE** | 106.7 | il dato piu' recente nel campione ha 106.7 ore (letto DENTRO i file, non dalla data del file) |
...
| robinhood: freschezza | 🔴 **FALLISCE** | 126.7 | il dato piu' recente nel campione ha 126.7 ore (letto DENTRO i file, non dalla data del file) |
...
| solana: freschezza | 🔴 **FALLISCE** | 214.7 | il dato piu' recente nel campione ha 214.7 ore (letto DENTRO i file, non dalla data del file) |
...
| base: timbro di acquisizione | 🟡 **ATTENZIONE** | 10.0 | 2 file su 20 fra i piu' recenti hanno il campo acq |
...
| solana: timbro di acquisizione | 🟡 **ATTENZIONE** | 0.0 | 0 file su 21 fra i piu' recenti hanno il campo acq |
| base: entita' duplicate | 🟢 **PASSA** | 0 | 1923 righe, 1923 pool distinti |
| base: storico dalla catena | 🟢 **PASSA** | 17964 | 17964 pool con storia dalla catena |
...
| robinhood: storico dalla catena | 🟢 **PASSA** | 27329 | 27329 pool con storia dalla catena |
