...
*2026-09-15 20:07 UTC · controllo continuo · €0*
...
| robinhood: scambi orfani | 🔴 **FALLISCE** | 83.0 | 4083 file su 4920 non si uniscono a nessuna serie di prezzo |
...
| robinhood: serie con scambi | 🟡 **ATTENZIONE** | 34.8 | 837 su 2403 |
| solana: freschezza | 🟡 **ATTENZIONE** | 19.3 | il dato piu' recente nel campione ha 19.3 ore (letto DENTRO i file, non dalla data del file) |
...
| base: storico utile | 🟢 **PASSA** | 88.3 | sulle righe COPERTE: 265 su 300 hanno almeno 6 scambi prima dell'entrata |
...
| robinhood: freschezza | 🟢 **PASSA** | 1.1 | il dato piu' recente nel campione ha 1.1 ore (letto DENTRO i file, non dalla data del file) |
| robinhood: storico dalla catena | 🟢 **PASSA** | 808 | 808 pool con storia dalla catena |
| robinhood: storico utile | 🟢 **PASSA** | 73.0 | sulle righe COPERTE: 219 su 300 hanno almeno 6 scambi prima dell'entrata |
| robinhood: storico, quante righe copre | 🟢 **PASSA** | 68.8 | 524 righe su 762 hanno la storia dalla catena |
