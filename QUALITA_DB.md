...
*2026-09-15 19:22 UTC · controllo continuo · €0*
...
| robinhood: feature scambi vive | 🔴 **FALLISCE** | 0.0 | solo 0 righe su 763 hanno scambi veri; le altre usano il valore di ripiego |
| robinhood: scambi orfani | 🔴 **FALLISCE** | 83.2 | 4083 file su 4905 non si uniscono a nessuna serie di prezzo |
...
| robinhood: freschezza | 🟡 **ATTENZIONE** | 11.0 | il dato piu' recente nel campione ha 11.0 ore (letto DENTRO i file, non dalla data del file) |
| robinhood: serie con scambi | 🟡 **ATTENZIONE** | 34.5 | 822 su 2386 |
| solana: freschezza | 🟡 **ATTENZIONE** | 21.6 | il dato piu' recente nel campione ha 21.6 ore (letto DENTRO i file, non dalla data del file) |
...
| robinhood: entita' duplicate | 🟢 **PASSA** | 0 | 763 righe, 763 pool distinti |
...
| robinhood: storico, quante righe copre | 🟢 **PASSA** | 68.4 | 522 righe su 763 hanno la storia dalla catena |
