...
*2026-09-19 16:56 UTC · controllo continuo · €0*
...
| solana: freschezza | 🔴 **FALLISCE** | 47.0 | il dato piu' recente nel campione ha 47.0 ore (letto DENTRO i file, non dalla data del file) |
| solana: scambi orfani | 🔴 **FALLISCE** | 65.3 | 3093 file su 4734 non si uniscono a nessuna serie di prezzo |
| base: freschezza | 🟡 **ATTENZIONE** | 14.8 | il dato piu' recente nel campione ha 14.8 ore (letto DENTRO i file, non dalla data del file) |
| base: scambi orfani | 🟡 **ATTENZIONE** | 30.6 | 663 file su 2167 non si uniscono a nessuna serie di prezzo |
| base: serie con scambi | 🟡 **ATTENZIONE** | 30.5 | 1504 su 4934 |
...
| robinhood: timbro di acquisizione | 🟡 **ATTENZIONE** | 22.2 | 2 file su 9 fra i piu' recenti hanno il campo acq |
...
| base: storico dalla catena | 🟢 **PASSA** | 11241 | 11241 pool con storia dalla catena |
...
| robinhood: storico dalla catena | 🟢 **PASSA** | 3443 | 3443 pool con storia dalla catena |
