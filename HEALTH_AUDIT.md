...
*2026-09-12 09:02Z · controllo automatico ogni 3h*

## 🔴 4 PROBLEMI RILEVATI

- 🟠 **solana**: dati FERMI da 3h (usable 893, trade 659) → collector forse bloccato
...
- 🟠 **base**: dati FERMI da 3h (usable 1145, trade 684) → collector forse bloccato

## Copertura dati per chain
| chain | token usabili | con trade | con dati PRE-ENTRATA |
|---|---|---|---|
| solana | 893 | 659 | **55%** (493) |
| bsc | 729 | 307 | **21%** (156) |
| base | 1145 | 684 | **42%** (477) |
