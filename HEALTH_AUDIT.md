...
*2026-09-05 14:49Z · controllo automatico ogni 3h*
...
- 🟠 **base**: dati FERMI da 3h (usable 1038, trade 679) → collector forse bloccato

## Copertura dati per chain
| chain | token usabili | con trade | con dati PRE-ENTRATA |
|---|---|---|---|
| solana | 807 | 633 | **58%** (466) |
| bsc | 714 | 307 | **22%** (156) |
| base | 1038 | 679 | **45%** (466) |
