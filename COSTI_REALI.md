...
*2026-09-12 09:36 UTC · quote vere da Jupiter su 1864 token Solana vivi · €0*
...
|---|---|---|---|---|
| $25 | **70.3%** | 3.6% | 100.0% | 11 |
| $100 | **90.4%** | 6.8% | 100.0% | 11 |
| $500 | **97.9%** | 9.3% | 100.0% | 11 |

- misure accumulate finora: **1864 token** (l'archivio cresce a ogni giro)
- token che NON si possono rivendere: **397** su 1864 (**21%**)
...
Costo misurato di andata e ritorno su $100: **90.4%** contro il **~30%** che assumiamo.
Pareggio necessario: **10.40x** contro l'**1,50x** del modello attuale.
