...
## 🔭 DALLA REVISIONE ESTERNA QUOTIDIANA (Astra, dal 06/09)

Il loop delle idee gira una volta al giorno e il primo giro ha gia' contestato **due mie regole**.

### ✅ Applicato: il placebo non e' piu' una ghigliottina
> *«Un segnale puo' descrivere il passato E prevedere il futuro: basta che il fenomeno persista.
> "Prima era gia' salito del 307%" dimostra che arrivate dopo un rialzo; non dimostra che arrivate
> troppo tardi.»*

Aveva ragione. Bocciavo un candidato appena vedevo momentum precedente. Ora, quando il momentum
c'e', il verbale fa **la seconda domanda**: a parita' di rialzo gia' avvenuto, il segnale aggiunge
qualcosa? Il confronto usa controlli appaiati **anche sul rialzo precedente**.
Potrei aver ucciso un candidato vivo — adesso non piu' senza appello.

### 🔴 Da verificare: il costo di Jupiter e di Solana, non di Robinhood
> *«Misure Jupiter non giustificano automaticamente il costo di Robinhood. E una quotazione non e'
> un'esecuzione realizzata.»*

Vero e non l'avevo notato: le 1.300 misure di costo vengono da Jupiter, che serve **Solana**.
Applicarle a Robinhood e' un trasferimento travestito da misura — lo stesso errore del 33% assunto,
un livello piu' in alto. **Se il +3,5% di Robinhood poggia su costi di un'altra chain, non vale.**

### Le tre idee proposte (da valutare, nessuna ancora aperta)
1. **Comprare l'esaurimento di un venditore**, non l'arrivo dei compratori
2. **Chi assorbe le vendite del gruppo coordinato** — distingue mercato vero da promozione
3. **La coda come portafoglio** — mediana zero non prova che sia una lotteria perdente
