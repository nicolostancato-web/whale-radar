...
*2026-09-15 21:25 UTC · 20 segnali nuovi messi alla prova su 428 token*
...
| `buy_grossi x ampiezza (voto)` | la quota di denaro che arriva da acquisti sopra i 500 dollari MOLTIPLICATO per quanto oscilla il prezzo prima di entrare | -99% (+0) |
| `buy_grossi x ampiezza (filtro)` | la quota di denaro che arriva da acquisti sopra i 500 dollari MOLTIPLICATO per quanto oscilla il prezzo prima di entrare | -99% (+0) |
| `buy_grossi / ampiezza (voto)` | la quota di denaro che arriva da acquisti sopra i 500 dollari RAPPORTATO a quanto oscilla il prezzo prima di entrare | -99% (+0) |
| `buy_grossi / ampiezza (filtro)` | la quota di denaro che arriva da acquisti sopra i 500 dollari RAPPORTATO a quanto oscilla il prezzo prima di entrare | -99% (+0) |
...
- `concentrazione_top5 (filtro)` — già bocciato 29 volte 5h fa (si riprova fra 7h o quando i dati crescono)
- `concentrazione_top1 (voto)` — già bocciato 38 volte 5h fa (si riprova fra 7h o quando i dati crescono)
- `concentrazione_top1 (filtro)` — già bocciato 27 volte 5h fa (si riprova fra 7h o quando i dati crescono)
- `n_compratori (voto)` — già bocciato 38 volte 5h fa (si riprova fra 7h o quando i dati crescono)
- `n_compratori (filtro)` — già bocciato 29 volte 5h fa (si riprova fra 7h o quando i dati crescono)
- `buy_medio (voto)` — già bocciato 38 volte 5h fa (si riprova fra 7h o quando i dati crescono)
- `buy_medio (filtro)` — già bocciato 25 volte 5h fa (si riprova fra 7h o quando i dati crescono)
- `buy_grossi (voto)` — già bocciato 38 volte 5h fa (si riprova fra 7h o quando i dati crescono)
