...
*2026-09-12 01:43 UTC · 1 segnali nuovi messi alla prova su 556 token*
...
- `concentrazione_top5 (filtro)` — già bocciato 16 volte 12h fa (si riprova fra 0h o quando i dati crescono)
- `concentrazione_top1 (voto)` — già bocciato 26 volte 3h fa (si riprova fra 9h o quando i dati crescono)
- `concentrazione_top1 (filtro)` — già bocciato 15 volte 0h fa (si riprova fra 12h o quando i dati crescono)
- `n_compratori (voto)` — già bocciato 26 volte 3h fa (si riprova fra 9h o quando i dati crescono)
- `n_compratori (filtro)` — già bocciato 16 volte 12h fa (si riprova fra 0h o quando i dati crescono)
- `buy_medio (voto)` — già bocciato 26 volte 3h fa (si riprova fra 9h o quando i dati crescono)
- `buy_medio (filtro)` — già bocciato 13 volte 6h fa (si riprova fra 6h o quando i dati crescono)
- `buy_grossi (voto)` — già bocciato 26 volte 3h fa (si riprova fra 9h o quando i dati crescono)
