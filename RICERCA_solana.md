...
|---|---|---|---|
| `trade_al_minuto (filtro)` | quanto è frenetico lo scambio | **-96%** | **+3 punti** |
| `n_compratori / buy_medio (filtro)` | quante persone diverse hanno comprato RAPPORTATO a quanto compra in media ciascuno | **-96%** | **+3 punti** |
...
|---|---|---|
| `trade_al_minuto (filtro)` | quanto è frenetico lo scambio | -96% (+3) |
| `n_compratori / buy_medio (filtro)` | quante persone diverse hanno comprato RAPPORTATO a quanto compra in media ciascuno | -96% (+3) |
