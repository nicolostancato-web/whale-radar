...
*2026-09-12 17:55 UTC · 20 segnali nuovi messi alla prova su 459 token*
...
- `concentrazione_top5 (filtro)` — già bocciato 19 volte 5h fa (si riprova fra 7h o quando i dati crescono)
- `concentrazione_top1 (voto)` — già bocciato 28 volte 5h fa (si riprova fra 7h o quando i dati crescono)
- `concentrazione_top1 (filtro)` — già bocciato 17 volte 5h fa (si riprova fra 7h o quando i dati crescono)
- `n_compratori (voto)` — già bocciato 28 volte 4h fa (si riprova fra 8h o quando i dati crescono)
- `n_compratori (filtro)` — già bocciato 19 volte 4h fa (si riprova fra 8h o quando i dati crescono)
- `buy_medio (voto)` — già bocciato 28 volte 4h fa (si riprova fra 8h o quando i dati crescono)
- `buy_medio (filtro)` — già bocciato 15 volte 4h fa (si riprova fra 8h o quando i dati crescono)
