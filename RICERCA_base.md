...
*2026-09-12 14:30 UTC · 2 segnali nuovi messi alla prova su 615 token*
...
Nessuno dei 2 candidati alza la percentuale di almeno 3 punti.
...
|---|---|---|
| `usd_primi20 x volume_ultima_su_media (voto)` | quanto pesano i primissimi 20 acquisti sul totale MOLTIPLICATO per se il volume sta accelerando proprio adesso | -97% (+2) |
...
- `n_compratori (voto)` — già bocciato 4 volte 3h fa (si riprova fra 9h o quando i dati crescono)
- `n_compratori (filtro)` — già bocciato 19 volte 9h fa (si riprova fra 3h o quando i dati crescono)
- `buy_medio (voto)` — già bocciato 5 volte 2h fa (si riprova fra 10h o quando i dati crescono)
