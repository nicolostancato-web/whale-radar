...
*2026-09-05 23:36 UTC · walk-forward onesto · il cancello del live si apre a +40% robusta su 150+ token*

| chain | media | **robusta** | trade in guadagno | peso dei 3 colpi migliori | giudizio |
|---|---|---|---|---|---|
| **robinhood** | +17% | **-20%** | 31% (71 trade) | 34% | 🔴 **NEGATIVA** |
| **base** | +3% | **+0%** | 35% (342 trade) | 4% | 🟡 **POSITIVA MA NON ANCORA SOLIDA** |
| **solana** | -9% | **-13%** | 27% (416 trade) | 5% | 🔴 **NEGATIVA** |
...
- su **77 token** il modello ne sceglie **71**, e ne vanno bene il **31%**  *(fonte: pipeline completo)*
- il colpo migliore ha fatto **+2203%** e da solo pesa il **28%** del risultato
...
- **tiene nel tempo?** prima metà dei token **-11%**, metà più recente **-32%** → ⚠️ **NO: sta peggiorando**. Un numero che funziona solo sui token vecchi è un ricordo, non un edge — il mercato è cambiato e la strategia va rifatta

## base

🟡 **POSITIVA MA NON ANCORA SOLIDA** — guadagna, ma serve alzarla prima di rischiare soldi

- su **1151 token** il modello ne sceglie **342**, e ne vanno bene il **35%**  *(fonte: pipeline multichain)*
- il colpo migliore ha fatto **+383%** e da solo pesa il **1%** del risultato
- il trade mediano fa **-8%** (è questo che succede *di solito*)
...
- su **712 token** il modello ne sceglie **416**, e ne vanno bene il **27%**  *(fonte: pipeline multichain)*
...
- **tiene nel tempo?** prima metà dei token **-20%**, metà più recente **-33%** → ✅ regge

> **Perché guardiamo la robusta e non la media:** la media la fanno i mostri. Se una chain fa +100%
