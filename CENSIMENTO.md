...
|---|---|---|---|---|---|---|---|
| **base** | 15202 | 241 | 12 | **11685** | **457** | 433 | 2374 |
| **solana** | 15249 | 17 | 0 | **13158** | **389** | 744 | 941 |
| **bsc** | 17541 | 5 | 0 | **16385** | **354** | 23 | 774 |

**base** — dei pool che abbiamo davvero interrogato, il **13% è nato morto**. Ma il **77%** dei pool scoperti non l'abbiamo mai chiesto: quello non dice niente sul mercato, dice quanto siamo lenti a raccogliere.
**solana** — dei pool che abbiamo davvero interrogato, il **19% è nato morto**. Ma il **86%** dei pool scoperti non l'abbiamo mai chiesto: quello non dice niente sul mercato, dice quanto siamo lenti a raccogliere.
