...
|---|---|---|---|
| **con insider** (early-buy da wallet ricorrenti vincenti) | 3 | **0%** | -37% |
| senza insider | 694 | 11% | -21% |
| *tutti (base rate)* | 697 | *11%* | *-21%* |

**LIFT = -10.8 punti** di win-rate rispetto alla media · **p = 1.0000** (probabilita' di vedere 0 vincenti su 3 per puro caso) · casi 3/40

## Wallet ricorrenti trovati: **587** (≥2 apparizioni da first-buyer, su 697 token)
